...
class InceptionV3Model(BaseModel):
    """InceptionV3 model implementation with transfer learning"""
    ...
    def build_model(self) -> Model:
        ...
        logger.info(f"InceptionV3 model built successfully")
    ...
    def fine_tune_top_layers(
        self, num_layers: int = 20, fine_tune_lr: float = None
    ) -> None:
        """Fine-tune the top N layers of InceptionV3"""
        if self.base_model is None:
...
def create_inceptionv3(
    ...
    return InceptionV3Model(num_classes=num_classes, input_shape=input_shape, **kwargs)
...
if __name__ == "__main__":
    ...
    print("\nInceptionV3 model testing completed successfully!")
