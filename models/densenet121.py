...
class DenseNet121Model(BaseModel):
    ...
    def build_model(self) -> Model:
        ...
        if self.input_shape[2] == 1:
            logger.info(f"Converting grayscale input {self.input_shape} to 3-channel for DenseNet121 compatibility")
    ...
    def compare_with_resnet(self) -> Dict[str, Any]:
        ...
        comparison = {
            ...
            'parameter_ratio': complexity['total_parameters'] / resnet50_stats['parameters'],
